...
Data simulation is a powerful approach for understanding your data and how it behaves.
...
Additionally, these generative models can simulate new hypothetic experiments that can be used to answer questions where the data is not available. 
