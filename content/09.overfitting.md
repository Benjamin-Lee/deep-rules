...
Just as a smarter student may have greater potential for memorization, deep learning models seem more prone to over fitting than traditional machine learning models.
...
That is, the data used for testing should be "locked away", and should only be used for evaluating the final model after all training and tuning steps are completed (_i.e._ used only once as a final evaluation).
