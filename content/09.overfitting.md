...
In essence, practitioners should split data into training, tuning, and single-use testing sets to assess the performance of the model on data that fully assesses generalization (_e.g._ by holding out all data from one hospital as a test set).
