...
In essence, split your data into training, tuning, and testing sets to assess the performance of the model on data it truly has not seen before, while also being cognizant of the danger of skewed or biased data artificially inflating accuracy.
