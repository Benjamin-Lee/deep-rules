...
To get good results, you must expect to train many networks across a wide range of different hyperparameter settings.
...
Again, beware of the choices made implicitly (that is, by default settings) by your framework of choice (for example, selection of optimization algorithm), as these seemingly trivial specifics can have significant effects on model performance.
