...
Similar to the suggestions in [Tip 4](#baselines) about starting with simpler models, try to start with a relatively small network, and to then increase the size and complexity as needed.
