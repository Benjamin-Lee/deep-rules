...
To trust deep learning models, we must combine knowledge of the data on which it was trained ([Tip 4](#know-your-problem)) with inspection of the model ([Tip 8](#blackbox)).
