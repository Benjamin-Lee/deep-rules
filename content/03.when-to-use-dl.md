...
This speaks to another potential advantage of traditional machine learning over deep learning, as there are currently more tools for automating the model selection and training process for traditional machine learning models than there are for deep learning models.
...
As long as data of sufficient quantity and quality is available (_i.e._ large amounts of accurate and labeled data), applications to areas of biology with related data characteristics, such as genetic medicine [@doi:10.1038/s41591-018-0279-0], radiology [@doi:10.1007/s11604-018-0726-3], microscopy [@doi:10.1364/OPTICA.4.001437], and pharmacovigilance [@doi:10.1093/jamia/ocw180], are similarly likely to benefit from deep learning techniques.
...
On the whole, initial evaluation as to whether similar problems (including analogous ones in other domains) have been solved successfully using deep learning can inform researchs as to the potential for deep learning to address their needs.
