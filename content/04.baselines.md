...
In addition, be sure to tune and compare current state-of-the-art tools (_e.g._, bioinformatics pipelines or image analysis workflows), regardless of whether they use machine learning, in order to gauge the relative effectiveness of your baseline and deep learning models.
