...
Since deep learning requires you to consider a larger number and variety of tuning parameters or algorithm settings (so-called hyperparameters) compared to more traditional methods, it is easy to fall into the trap of performing an unnecessarily convoluted analysis.
...
If you wish to compare different learning algorithms, you should tune the settings of both traditional and DL-based methods to optimize performance before making claims about relative performance differences.
