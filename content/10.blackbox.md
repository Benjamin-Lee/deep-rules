...
Alternatively, algorithms based on Garson's work [@url:https://dl.acm.org/citation.cfm?id=129452] can help to investigate the weights of a DL model to better understand it [TODO detail Garson’s algorithm?].
