...
2. Use traditional methods to establish performance baselines
  ...
  - Use a (generalized) linear model to establish a performance baseline early on in the project to help with debugging DL implementations [#41](https://github.com/Benjamin-Lee/deep-rules/issues/41)
